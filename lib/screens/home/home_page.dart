...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _isLoading ? LoaderScreen() : pages.elementAt(current_index),
          ...
          : Container(
              ...
              child: BottomNavigationBar(
                  ...
                  items: const <BottomNavigationBarItem>[
                    ...
                    BottomNavigationBarItem(
                        icon:
                            ImageIcon(AssetImage("assets/Icons/Donation.png")),
                        label: "Donate"),
                    BottomNavigationBarItem(
                        icon:
                            ImageIcon(AssetImage("assets/Icons/Vactivity.png")),
                        label: "Volunteer"),
                    BottomNavigationBarItem(
